...
import { bindingAvailable, CIPHER_INFO, MAC_INFO } from "./crypto";

export const eddsaSupported = (() => {
  if (
...
export const curve25519Supported =
...
export const SUPPORTED_KEX = DEFAULT_KEX.concat([
  // https://tools.ietf.org/html/rfc4419#section-4
...
export const SUPPORTED_SERVER_HOST_KEY = DEFAULT_SERVER_HOST_KEY.concat([
  "ssh-dss",
]);
...
export const SUPPORTED_CIPHER = DEFAULT_CIPHER.concat(
  [
    "aes256-cbc",
    "aes192-cbc",
    "aes128-cbc",
...
export const SUPPORTED_MAC = DEFAULT_MAC.concat(
  [
    "hmac-md5",
...
export const SUPPORTED_COMPRESSION = DEFAULT_COMPRESSION.concat([]);
...
export default {
  ...
  CHANNEL_EXTENDED_DATATYPE: CHANNEL_EXTENDED_DATATYPE,
...
export const DISCONNECT_REASON_BY_VALUE = Array.from(
